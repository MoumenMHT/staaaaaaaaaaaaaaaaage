...
<body>
    ...
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container">
          <a class="navbar-brand" href="index.php" id="logo"><span>N</span>aftal</a>
                ...
                <div class="col-md-4 py-3 py-md-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-sub-title">Sauudi Aribia</p>
                          <p class="card-info">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eius, provident.</p>
                          <button id="myButton" class="card-btn image-button" onclick="showForm()">Book Now</button>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row" style="margin-top: 50px;">
          ...
          <div class="col-md-6 py-3 py-md-0">
            ...
            <button id="about-btn" onclick="url='https://www.naftal.dz/fr/'">Read More...</button>
          </div>
